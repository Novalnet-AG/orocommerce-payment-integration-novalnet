...
class NovalnetHelper
{
    ...
    public function getCommonParams($order, $router, $paymentTransaction, $request, $userLocalizationManager, &$paygateParams)
    {
        ...
        $paygateParams['return_method'] = 'GET';
        $paygateParams['error_return_method'] = 'GET';
     ...
     * @return null
     */
    public function insertNovalnetTransactionTable($doctrineHelper, $data, $paymentAccessKey)
    {
