 ...
 */
class NovalnetPrzelewyConfigProvider extends NovalnetConfigProvider implements
    NovalnetPrzelewyConfigProviderInterface
{
    /**
     * @var NovalnetPrzelewyConfigInterface[]
     */
    protected $configs = [];
