 ...
 */
class NovalnetMultibancoConfigProvider extends NovalnetConfigProvider implements
    NovalnetMultibancoConfigProviderInterface
{
    /**
     * @var NovalnetMultibancoConfigInterface[]
     */
    protected $configs = [];
