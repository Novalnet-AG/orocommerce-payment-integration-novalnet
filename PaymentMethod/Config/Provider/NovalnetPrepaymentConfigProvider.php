 ...
 */
class NovalnetPrepaymentConfigProvider extends NovalnetConfigProvider implements
    NovalnetPrepaymentConfigProviderInterface
{
    /**
     * @var NovalnetPrepaymentConfigInterface[]
     */
    protected $configs = [];
