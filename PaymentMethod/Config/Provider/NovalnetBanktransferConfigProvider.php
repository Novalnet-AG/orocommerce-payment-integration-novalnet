 ...
 */
class NovalnetBanktransferConfigProvider extends NovalnetConfigProvider implements
    NovalnetBanktransferConfigProviderInterface
{
    /**
     * @var NovalnetBanktransferConfigInterface[]
     */
    protected $configs = [];
