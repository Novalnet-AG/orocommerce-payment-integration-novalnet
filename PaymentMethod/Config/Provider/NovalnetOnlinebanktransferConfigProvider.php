 ...
 */
class NovalnetOnlinebanktransferConfigProvider extends NovalnetConfigProvider implements
    NovalnetOnlinebanktransferConfigProviderInterface
{
    /**
     * @var NovalnetOnlinebanktransferConfigInterface[]
     */
    protected $configs = [];
