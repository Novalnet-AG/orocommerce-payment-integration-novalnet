 ...
 */
class NovalnetPostfinanceConfigProvider extends NovalnetConfigProvider implements
    NovalnetPostfinanceConfigProviderInterface
{
    /**
     * @var NovalnetPostfinanceConfigInterface[]
     */
    protected $configs = [];
