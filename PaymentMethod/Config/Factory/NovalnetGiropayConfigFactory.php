...
class NovalnetGiropayConfigFactory extends NovalnetConfigFactory implements NovalnetGiropayConfigFactoryInterface
{
    ...
    public function createConfig(NovalnetSettings $settings)
    {
        ...
        $params[NovalnetGiropayConfig::CALLBACK_TESTMODE] = $settings->getCallbackTestmode();
        $params[NovalnetGiropayConfig::EMAIL_NOTIFICATION] = $settings->getEmailNotification();
        $params[NovalnetGiropayConfig::EMAIL_TO] = $settings->getEmailTo();
        $params[NovalnetGiropayConfig::EMAIL_BCC] = $settings->getEmailBcc();
