...
class NovalnetPrepaymentConfigFactory extends NovalnetConfigFactory implements NovalnetPrepaymentConfigFactoryInterface
{
    ...
    public function createConfig(NovalnetSettings $settings)
    {
        ...
        $params[NovalnetPrepaymentConfig::CALLBACK_TESTMODE] = $settings->getCallbackTestmode();
        $params[NovalnetPrepaymentConfig::EMAIL_NOTIFICATION] = $settings->getEmailNotification();
        $params[NovalnetPrepaymentConfig::EMAIL_TO] = $settings->getEmailTo();
        $params[NovalnetPrepaymentConfig::EMAIL_BCC] = $settings->getEmailBcc();
