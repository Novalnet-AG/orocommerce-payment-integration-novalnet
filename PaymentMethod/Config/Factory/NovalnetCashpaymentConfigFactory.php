...
class NovalnetCashpaymentConfigFactory extends NovalnetConfigFactory implements NovalnetCashpaymentConfigFactoryInterface
{
    ...
    public function createConfig(NovalnetSettings $settings)
    {
        ...
        $params[NovalnetCashpaymentConfig::CALLBACK_TESTMODE] = $settings->getCallbackTestmode();
        $params[NovalnetCashpaymentConfig::EMAIL_NOTIFICATION] = $settings->getEmailNotification();
        $params[NovalnetCashpaymentConfig::EMAIL_TO] = $settings->getEmailTo();
        $params[NovalnetCashpaymentConfig::EMAIL_BCC] = $settings->getEmailBcc();
