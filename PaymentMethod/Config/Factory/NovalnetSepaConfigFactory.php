...
class NovalnetSepaConfigFactory extends NovalnetConfigFactory implements NovalnetSepaConfigFactoryInterface
{
    ...
    public function createConfig(NovalnetSettings $settings)
    {
        ...
        $params[NovalnetSepaConfig::CALLBACK_TESTMODE] = $settings->getCallbackTestmode();
        $params[NovalnetSepaConfig::EMAIL_NOTIFICATION] = $settings->getEmailNotification();
        $params[NovalnetSepaConfig::EMAIL_TO] = $settings->getEmailTo();
        $params[NovalnetSepaConfig::EMAIL_BCC] = $settings->getEmailBcc();
