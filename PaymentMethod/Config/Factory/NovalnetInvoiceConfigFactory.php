...
class NovalnetInvoiceConfigFactory extends NovalnetConfigFactory implements NovalnetInvoiceConfigFactoryInterface
{
    ...
    public function createConfig(NovalnetSettings $settings)
    {
        ...
        $params[NovalnetInvoiceConfig::CALLBACK_TESTMODE] = $settings->getCallbackTestmode();
        $params[NovalnetInvoiceConfig::EMAIL_NOTIFICATION] = $settings->getEmailNotification();
        $params[NovalnetInvoiceConfig::EMAIL_TO] = $settings->getEmailTo();
        $params[NovalnetInvoiceConfig::EMAIL_BCC] = $settings->getEmailBcc();
