...
class NovalnetIdealConfigFactory extends NovalnetConfigFactory implements NovalnetIdealConfigFactoryInterface
{
    ...
    public function createConfig(NovalnetSettings $settings)
    {
        ...
        $params[NovalnetIdealConfig::CALLBACK_TESTMODE] = $settings->getCallbackTestmode();
        $params[NovalnetIdealConfig::EMAIL_NOTIFICATION] = $settings->getEmailNotification();
        $params[NovalnetIdealConfig::EMAIL_TO] = $settings->getEmailTo();
        $params[NovalnetIdealConfig::EMAIL_BCC] = $settings->getEmailBcc();
